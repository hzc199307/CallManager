...
public class DBHelper extends SQLiteOpenHelper {
   ...
   //数据库文件目标存放路径为系统默认位置，com.xp.callmanager 是你的包名
   private static String DB_PATH        = "/data/data/com.xp.callmanager/databases/";
/*
   //如果你想把数据库文件存放在SD卡的话
...
*/
   ...
   private static String DB_NAME         = "attribution.db";
   private static String ASSETS_NAME     = "attribution/attribution.db";
   ...
   private final Context myContext;
     ...
     * 此例中分割为 attribution.db.3h1 ~~ attribution.db.3h15
     */
   //第一个文件名后缀
